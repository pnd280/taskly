...
//   RichEditor({super.key, required this.onUpdateCallBack, this.text, this.enable = false});
...
Widget RichEditor(
    {required onUpdateCallBack, String? text, required context, bool enable = false}) {
